...
public class PulsarProducerDemo {
    public static void main(String[] args) throws PulsarClientException {
        ...
        String topic = "persistent://public/default/test01";
        ...
        // 4. 发送多条消息
        for (int i = 1; i <= 5; i++) {
            String content = "{\"id\":3,\"activity_name\":\"限时秒杀\",\"activity_type\":\"promotion\",\"activity_desc\":\"全场五折限时抢购\",\"event_time\":\"1766386454000\"}" ;
