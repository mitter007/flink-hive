...
// 5. 建表sql以hive为目的地
        ...
        tableEnv.executeSql("drop table if exists t2hiveTable");
...
//指定方言
        ...
        // 6. 同步2个表
        tableEnv.executeSql("INSERT INTO t2hiveTable "
                + "SELECT id,ts,vc,DATE_FORMAT(pt, 'yyyy-MM-dd'), DATE_FORMAT(pt, 'HH') FROM t1_pt").print();
