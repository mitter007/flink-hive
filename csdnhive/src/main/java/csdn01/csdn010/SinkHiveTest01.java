...
// 5. 建表sql以hive为目的地
        ...
        tableEnv.executeSql("drop table if exists t3hiveTable");
...
//指定方言
        ...
        // 6. 同步2个表
        tableEnv.executeSql("INSERT INTO t3hiveTable "
                + "SELECT id,ts,vc,DATE_FORMAT(pt, 'yyyy-MM-dd') FROM t1_pt").print();
