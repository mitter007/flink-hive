...
// 5. 建表sql以hive为目的地
        ...
        tableEnv.executeSql("drop table if exists t5hiveTable");

        tableEnv.executeSql("CREATE TABLE IF NOT EXISTS t5hiveTable ("
...
//        tableEnv.sqlQuery("select * from kafka01").execute().print();
        ...
        //同步两张表
        tableEnv.executeSql("INSERT INTO t5hiveTable "
