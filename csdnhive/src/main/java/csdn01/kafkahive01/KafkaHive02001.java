...
//指定方言
 ...
 /*       properties.setProperty("security.protocol","SASL_PLAINTEXT");
        ...
        streamSource.print();
        Table table = tableEnv.fromDataStream(streamSource, "id,ts");
...
//        tableEnv.getConfig().setSqlDialect(SqlDialect.HIVE);
        TableResult tableResult = tableEnv.executeSql("INSERT INTO t7hiveTable "
                + "SELECT id,ts DATE_FORMAT(ts, 'yyyy-MM-dd') FROM myTable");
