...
// 5. 建表sql以hive为目的地
        ...
        tableEnv.executeSql("drop table if exists t8hiveTable");

        tableEnv.executeSql("CREATE TABLE IF NOT EXISTS t8hiveTable ("
...
//                Integer vc = jsonObject.getInteger("vc");
        ...
        //同步两张表
        tableEnv.executeSql("INSERT INTO t8hiveTable "
